...
if __name__ == "__main__":
    ...
    my_spectra.fourier_computation(fftlen=64, ds_ms=100, pol="I") #I, Q, U, L, V, XX, YY
    ...
    my_dynspec_data = my_spectra.get_spectra() #get_spectra will scrunch in time will get_data will keep the time domain
